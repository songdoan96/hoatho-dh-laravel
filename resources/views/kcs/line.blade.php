            ...
            <div class="h-full w-full overflow-hidden bg-blue-800 text-white text-xl uppercase flex flex-col gap-1">
                <div class="h-[150px] flex border-b-2">
                    <div class="w-1/4 h-full left flex flex-col justify-between items-center p-2 border-r-2 border-l-2">
                        ...
                        <div class="flex h-1/3 w-full justify-between items-center font-extrabold text-3xl">
                            @isset($kcs)
                    ...
                    <div class="center flex-1 h-full p-2 flex font-extrabold">
                        ...
                        <span class="text-center w-1/2">
                            ...
                            <p class="text-8xl number">{{ $dmhientai ?? 0 }}</p>
                        </span>
                    </div>
                ...
                <div class="h-[calc(100vh-150px)] text-3xl leading-none font-extrabold grid grid-cols-4 gap-1">
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>SỐ LƯỢNG ĐẠT</span>
                        <span class="text-8xl number">{{ $kcs->sldat ?? '--' }}</span>
                    </div>
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>TỶ LỆ ĐẠT</span>
                        <span class="text-8xl number tracking-wider">
                            @isset($tyleloi)
                    ...
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        ...
                        <span class="text-8xl number">{{ $kcs->slloi ?? '--' }}</span>
                    </div>
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>TỶ LỆ LỖI</span>
                        <span class="text-8xl number tracking-wider">
                    ...
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>BTP CẤP</span>
                        <span class="text-8xl number">{{ $plan->btpcap }}</span>
                    </div>
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>VỐN</span>
                        <span class="text-8xl number tracking-wider">{{ isset($von) ? round($von, 1) : '--' }}</span>
                    </div>
                    <div class="border-2 text-center flex flex-col items-center gap-2 p-2">
                        <span>NHẬP KHO</span>
                        <a href="{{ route('produce.editWarehouseUpdate', $plan) }}" class="text-8xl number">
